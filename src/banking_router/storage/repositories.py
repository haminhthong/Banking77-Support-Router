        ...
        try:
            connection.execute(
                ...
                (
                    ...
                    if queue_prediction
                    else result.decision.queue_id,
                    queue_prediction.confidence
                    if queue_prediction
                    else result.prediction.confidence,
                    ...
                    if result.decision.action == "priority_human_review"
                    else (
                        "PENDING_REVIEW"
        ...
        try:
            ...
            cursor = connection.execute(
                ...
                (
                    ...
                    resolution,
                    now,
                    redact_pii(notes) if notes else None,
                    reason_code,
                ),
            )
            connection.execute(
            ...
            return {
                ...
                "queue_corrected": final_queue is not None
                and ticket["predicted_queue"] != final_queue,
